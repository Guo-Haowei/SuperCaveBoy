...
//     if (!obj1.vspeed || !obj2.bound || !obj1.bound) return false;
//     var bound1 = obj1.bound, bound2 = obj2.bound;
// if (obj1.x+bound1.x+bound1.width-STEPOFFSET >= obj2.x+bound2.x &&
//     obj1.x+bound1.x+STEPOFFSET <= obj2.x+bound2.x+bound2.width) {
...
//     if (obj1.y+bound1.y+bound1.height+vspeed >= obj2.y+bound2.y
// && obj1.y+bound1.y+vspeed <= obj2.y+bound2.y+bound2.height) {
